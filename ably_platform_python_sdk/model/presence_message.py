...
class PresenceMessage(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["action", "clientId", "connectionId", "data", "encoding", "extras", "id", "timestamp", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["action", "clientId", "connectionId", "data", "encoding", "extras", "id", "timestamp", ], str]):
