...
class BaseApi(api_client.Api):
    ...
    def _put_push_device_details_mapped_args(
        self,
        device_id: str,
    ...
    async def _aput_push_device_details_oapg(
        self,
    ...
    def _put_push_device_details_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
...
class PutPushDeviceDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aput_push_device_details(
        self,
        device_id: str,
        client_id: typing.Optional[str] = None,
        device_secret: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._put_push_device_details_mapped_args(
            device_id=device_id,
            client_id=client_id,
        ...
        return await self._aput_push_device_details_oapg(
            body=args.body,
    ...
    def put_push_device_details(
        ...
        return self._put_push_device_details_oapg(
            body=args.body,
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
...
class PutPushDeviceDetails(BaseApi):
    ...
    async def aput_push_device_details(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aput_push_device_details(
            device_id=device_id,
            client_id=client_id,
            device_secret=device_secret,
            form_factor=form_factor,
    ...
    def put_push_device_details(
        ...
        raw_response = self.raw.put_push_device_details(
            device_id=device_id,
            client_id=client_id,
            device_secret=device_secret,
            form_factor=form_factor,
