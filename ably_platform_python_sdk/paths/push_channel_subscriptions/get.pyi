...
class BaseApi(api_client.Api):
    ...
    def _get_push_subscriptions_on_channels_mapped_args(
        self,
    ...
    async def _aget_push_subscriptions_on_channels_oapg(
        self,
    ...
    def _get_push_subscriptions_on_channels_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetPushSubscriptionsOnChannelsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_push_subscriptions_on_channels(
        self,
        x_ably_version: typing.Optional[str] = None,
        format: typing.Optional[str] = None,
        channel: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_push_subscriptions_on_channels_mapped_args(
        ...
        return await self._aget_push_subscriptions_on_channels_oapg(
    ...
    def get_push_subscriptions_on_channels(
        ...
        return self._get_push_subscriptions_on_channels_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class GetPushSubscriptionsOnChannels(BaseApi):
    ...
    async def aget_push_subscriptions_on_channels(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_push_subscriptions_on_channels(
            x_ably_version=x_ably_version,
            format=format,
            channel=channel,
            device_id=device_id,
    ...
    def get_push_subscriptions_on_channels(
        ...
        raw_response = self.raw.get_push_subscriptions_on_channels(
            x_ably_version=x_ably_version,
            format=format,
            channel=channel,
            device_id=device_id,
