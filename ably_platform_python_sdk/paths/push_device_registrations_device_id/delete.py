...
class BaseApi(api_client.Api):
    ...
    def _unregister_push_device_mapped_args(
        self,
        device_id: str,
    ...
    async def _aunregister_push_device_oapg(
        self,
    ...
    def _unregister_push_device_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class UnregisterPushDeviceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aunregister_push_device(
        self,
        device_id: str,
        x_ably_version: typing.Optional[str] = None,
        format: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._unregister_push_device_mapped_args(
            device_id=device_id,
            x_ably_version=x_ably_version,
            format=format,
        )
        return await self._aunregister_push_device_oapg(
    ...
    def unregister_push_device(
        ...
        return self._unregister_push_device_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class UnregisterPushDevice(BaseApi):
    ...
    async def aunregister_push_device(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aunregister_push_device(
            device_id=device_id,
            x_ably_version=x_ably_version,
            format=format,
            **kwargs,
    ...
    def unregister_push_device(
        ...
        raw_response = self.raw.unregister_push_device(
            device_id=device_id,
            x_ably_version=x_ably_version,
            format=format,
        )
