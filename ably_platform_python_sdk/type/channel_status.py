...
from ably_platform_python_sdk.type.occupancy import Occupancy

class RequiredChannelStatus(TypedDict):
...
class OptionalChannelStatus(TypedDict, total=False):
    occupancy: Occupancy

class ChannelStatus(RequiredChannelStatus, OptionalChannelStatus):
    pass
