...
class GetTimeRaw(BaseApi):
    ...
    async def aget_time(
        ...
        **kwargs,
        ...
        args = self._get_time_mapped_args(
            x_ably_version=x_ably_version,
            format=format,
        )
        return await self._aget_time_oapg(
    ...
    def get_time(
        ...
        return self._get_time_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class GetTime(BaseApi):
    ...
    async def aget_time(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_time(
            x_ably_version=x_ably_version,
            format=format,
            **kwargs,
        )
        if validate:
            return RootModel[typing.List[int]](raw_response.body).root
    ...
    def get_time(
        ...
        raw_response = self.raw.get_time(
            x_ably_version=x_ably_version,
            format=format,
        )
        if validate:
