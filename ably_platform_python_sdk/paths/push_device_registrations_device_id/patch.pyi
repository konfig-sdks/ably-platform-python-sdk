...
SchemaForRequestBodyApplicationXWwwFormUrlencoded = DeviceDetailsSchema
...
class BaseApi(api_client.Api):
    ...
    def _patch_push_device_details_mapped_args(
        self,
        device_id: str,
    ...
    async def _apatch_push_device_details_oapg(
        self,
    ...
    def _patch_push_device_details_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
...
class PatchPushDeviceDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apatch_push_device_details(
        self,
        device_id: str,
        client_id: typing.Optional[str] = None,
        device_secret: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._patch_push_device_details_mapped_args(
            device_id=device_id,
            client_id=client_id,
        ...
        return await self._apatch_push_device_details_oapg(
            body=args.body,
    ...
    def patch_push_device_details(
        ...
        return self._patch_push_device_details_oapg(
            body=args.body,
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
...
class PatchPushDeviceDetails(BaseApi):
    ...
    async def apatch_push_device_details(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.apatch_push_device_details(
            device_id=device_id,
            client_id=client_id,
            device_secret=device_secret,
            form_factor=form_factor,
    ...
    def patch_push_device_details(
        ...
        raw_response = self.raw.patch_push_device_details(
            device_id=device_id,
            client_id=client_id,
            device_secret=device_secret,
            form_factor=form_factor,
