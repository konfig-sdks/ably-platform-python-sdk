...
class BaseApi(api_client.Api):
    ...
    def _unregister_all_push_devices_mapped_args(
        self,
    ...
    async def _aunregister_all_push_devices_oapg(
        self,
    ...
    def _unregister_all_push_devices_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UnregisterAllPushDevicesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aunregister_all_push_devices(
        self,
        x_ably_version: typing.Optional[str] = None,
        format: typing.Optional[str] = None,
        device_id: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._unregister_all_push_devices_mapped_args(
            x_ably_version=x_ably_version,
            format=format,
            device_id=device_id,
            client_id=client_id,
        )
        return await self._aunregister_all_push_devices_oapg(
    ...
    def unregister_all_push_devices(
        ...
        return self._unregister_all_push_devices_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class UnregisterAllPushDevices(BaseApi):
    ...
    async def aunregister_all_push_devices(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aunregister_all_push_devices(
            x_ably_version=x_ably_version,
            format=format,
            device_id=device_id,
            client_id=client_id,
    ...
    def unregister_all_push_devices(
        ...
        raw_response = self.raw.unregister_all_push_devices(
            x_ably_version=x_ably_version,
            format=format,
            device_id=device_id,
            client_id=client_id,
