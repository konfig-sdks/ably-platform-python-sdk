...
SchemaFor200ResponseBodyApplicationJson = ChannelDetailsSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_metadata_of_channel_mapped_args(
        self,
        channel_id: str,
    ...
    async def _aget_metadata_of_channel_oapg(
        self,
    ...
    def _get_metadata_of_channel_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class GetMetadataOfChannelRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_metadata_of_channel(
        self,
        channel_id: str,
        x_ably_version: typing.Optional[str] = None,
        format: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_metadata_of_channel_mapped_args(
            channel_id=channel_id,
            x_ably_version=x_ably_version,
            format=format,
        )
        return await self._aget_metadata_of_channel_oapg(
    ...
    def get_metadata_of_channel(
        ...
        return self._get_metadata_of_channel_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class GetMetadataOfChannel(BaseApi):
    ...
    async def aget_metadata_of_channel(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ChannelDetailsPydantic:
        raw_response = await self.raw.aget_metadata_of_channel(
            channel_id=channel_id,
            x_ably_version=x_ably_version,
            format=format,
            **kwargs,
        ...
        if validate:
            return ChannelDetailsPydantic(**raw_response.body)
        return api_client.construct_model_instance(ChannelDetailsPydantic, raw_response.body)
    ...
    def get_metadata_of_channel(
        ...
        raw_response = self.raw.get_metadata_of_channel(
            channel_id=channel_id,
            x_ably_version=x_ably_version,
            format=format,
        )
