...
class BaseApi(api_client.Api):
    ...
    def _get_channels_with_push_subscribers_mapped_args(
        self,
    ...
    async def _aget_channels_with_push_subscribers_oapg(
        self,
    ...
    def _get_channels_with_push_subscribers_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetChannelsWithPushSubscribersRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_channels_with_push_subscribers(
        self,
        x_ably_version: typing.Optional[str] = None,
        format: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_channels_with_push_subscribers_mapped_args(
            x_ably_version=x_ably_version,
            format=format,
        )
        return await self._aget_channels_with_push_subscribers_oapg(
    ...
    def get_channels_with_push_subscribers(
        ...
        return self._get_channels_with_push_subscribers_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class GetChannelsWithPushSubscribers(BaseApi):
    ...
    async def aget_channels_with_push_subscribers(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_channels_with_push_subscribers(
            x_ably_version=x_ably_version,
            format=format,
            **kwargs,
        )
        if validate:
            return RootModel[typing.List[str]](raw_response.body).root
    ...
    def get_channels_with_push_subscribers(
        ...
        raw_response = self.raw.get_channels_with_push_subscribers(
            x_ably_version=x_ably_version,
            format=format,
        )
        if validate:
