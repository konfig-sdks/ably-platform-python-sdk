...
class LinkSchema(
    ...
    class MetaOapg:
        regex=[{
            'pattern': r'(<(.*)?>; rel=\"(first|current|last)?\",)*(<(.*)?>; rel=\"(first|current|last)?\")+',
        }]
...
class BaseApi(api_client.Api):
    ...
    def _get_presence_history_of_channel_mapped_args(
        self,
        channel_id: str,
    ...
    async def _aget_presence_history_of_channel_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/channels/{channel_id}/presence/history',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_presence_history_of_channel_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class GetPresenceHistoryOfChannelRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_presence_history_of_channel(
        self,
        channel_id: str,
        x_ably_version: typing.Optional[str] = None,
        format: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_presence_history_of_channel_mapped_args(
        ...
        return await self._aget_presence_history_of_channel_oapg(
    ...
    def get_presence_history_of_channel(
        ...
        return self._get_presence_history_of_channel_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class GetPresenceHistoryOfChannel(BaseApi):
    ...
    async def aget_presence_history_of_channel(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_presence_history_of_channel(
            channel_id=channel_id,
            x_ably_version=x_ably_version,
            format=format,
            start=start,
    ...
    def get_presence_history_of_channel(
        ...
        raw_response = self.raw.get_presence_history_of_channel(
            channel_id=channel_id,
            x_ably_version=x_ably_version,
            format=format,
            start=start,
