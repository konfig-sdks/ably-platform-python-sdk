...
class BaseApi(api_client.Api):
    ...
    def _update_push_device_details_mapped_args(
        self,
        device_id: str,
    ...
    async def _aupdate_push_device_details_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/push/deviceRegistrations/{device_id}/resetUpdateToken',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _update_push_device_details_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class UpdatePushDeviceDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_push_device_details(
        self,
        device_id: str,
        x_ably_version: typing.Optional[str] = None,
        format: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._update_push_device_details_mapped_args(
            device_id=device_id,
            x_ably_version=x_ably_version,
            format=format,
        )
        return await self._aupdate_push_device_details_oapg(
    ...
    def update_push_device_details(
        ...
        return self._update_push_device_details_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class UpdatePushDeviceDetails(BaseApi):
    ...
    async def aupdate_push_device_details(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_push_device_details(
            device_id=device_id,
            x_ably_version=x_ably_version,
            format=format,
            **kwargs,
    ...
    def update_push_device_details(
        ...
        raw_response = self.raw.update_push_device_details(
            device_id=device_id,
            x_ably_version=x_ably_version,
            format=format,
        )
